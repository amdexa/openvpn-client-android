...
import com.amdexa.openvpn.fragments.Utils;
import com.amdexa.openvpn.views.FileSelectLayout;

import static com.amdexa.openvpn.views.FileSelectLayout.FileSelectCallback;

public class ConfigConverter extends BaseActivity implements FileSelectCallback, View.OnClickListener {

    public static final String IMPORT_PROFILE = "com.amdexa.openvpn.IMPORT_PROFILE";

...
package com.amdexa.openvpn.api;
...
import com.amdexa.openvpn.core.ConfigParser;
import com.amdexa.openvpn.core.ConfigParser.ConfigParseError;
import com.amdexa.openvpn.core.ConnectionStatus;
import com.amdexa.openvpn.core.IOpenVPNServiceInternal;
import com.amdexa.openvpn.core.OpenVPNService;
import com.amdexa.openvpn.core.ProfileManager;
import com.amdexa.openvpn.core.VPNLaunchHelper;
import com.amdexa.openvpn.core.VpnStatus;
    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
        ...
        private void startProfile(VpnProfile vp)
        {
            ...
            if(vpnPermissionIntent != null || neddPassword != 0){
                ...
                shortVPNIntent.setClass(getBaseContext(), com.amdexa.openvpn.LaunchVPN.class);
                shortVPNIntent.putExtra(com.amdexa.openvpn.LaunchVPN.EXTRA_KEY, vp.getUUIDString());
                shortVPNIntent.putExtra(com.amdexa.openvpn.LaunchVPN.EXTRA_HIDELOG, true);

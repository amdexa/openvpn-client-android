...
import com.amdexa.openvpn.api.ExternalCertificateProvider;
...
public class ExtAuthHelper {
    ...
    public static final String ACTION_CERT_CONFIGURATION = "com.amdexa.openvpn.api.ExternalCertificateConfiguration";
    public static final String ACTION_CERT_PROVIDER = "com.amdexa.openvpn.api.ExternalCertificateProvider";

    public static final String EXTRA_ALIAS = "com.amdexa.openvpn.api.KEY_ALIAS";
    public static final String EXTRA_DESCRIPTION = "com.amdexa.openvpn.api.KEY_DESCRIPTION";

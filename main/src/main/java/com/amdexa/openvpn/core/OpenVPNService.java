...
import com.amdexa.openvpn.LaunchVPN;
import com.amdexa.openvpn.R;
import com.amdexa.openvpn.VpnProfile;
import com.amdexa.openvpn.activities.DisconnectVPN;
import com.amdexa.openvpn.activities.MainActivity;
import com.amdexa.openvpn.api.ExternalAppDatabase;
import com.amdexa.openvpn.core.VpnStatus.ByteCountListener;
import com.amdexa.openvpn.core.VpnStatus.StateListener;

import static com.amdexa.openvpn.core.ConnectionStatus.LEVEL_CONNECTED;
import static com.amdexa.openvpn.core.ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT;
import static com.amdexa.openvpn.core.NetworkSpace.IpAddress;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    public static final String START_SERVICE = "com.amdexa.openvpn.START_SERVICE";
    public static final String START_SERVICE_STICKY = "com.amdexa.openvpn.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "com.amdexa.openvpn.NOTIFICATION_ALWAYS_VISIBLE";
    public static final String DISCONNECT_VPN = "com.amdexa.openvpn.DISCONNECT_VPN";
    ...
    private static final String PAUSE_VPN = "com.amdexa.openvpn.PAUSE_VPN";
    private static final String RESUME_VPN = "com.amdexa.openvpn.RESUME_VPN";
    ...
    synchronized void unregisterDeviceStateReceiver() {
        if (mDeviceStateReceiver != null)
            try {
                ...
                // java.lang.IllegalArgumentException: Receiver not registered: com.amdexa.openvpn.NetworkSateReceiver@41a61a10
                // Ignore for now ...
                iae.printStackTrace();
            }
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class cl = Class.forName("com.amdexa.openvpn.core.OpenVPNThreadv3");
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("com.amdexa.openvpn.VPN_STATUS");
